...
class PurchaseRequestLine(models.Model):
        ...
        for rec in self:
            ...
            for line in rec.purchase_lines.filtered(
                ...
                if rec.product_uom_id and\
                        line.product_uom != rec.product_id.uom_id:
                    rec.purchased_qty += line.product_id.uom_id._compute_quantity(
                        line.product_qty, rec.product_id.uom_id)
                else:
    ...
    def _calc_new_qty(self, request_line, po_line=None,
        ...
        uom = request_line.product_id.uom_id
        ...
        for rl in po_line.purchase_request_lines:
            rl_qty += rl.product_id.uom_id._compute_quantity(
